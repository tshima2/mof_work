...
class PropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prop" do
    assert_difference('Prop.count') do
      post props_url, params: { prop: { address: @prop.address, age: @prop.age, name: @prop.name, remarks: @prop.remarks, rent: @prop.rent } }
    end
  ...
  test "should update prop" do
    patch prop_url(@prop), params: { prop: { address: @prop.address, age: @prop.age, name: @prop.name, remarks: @prop.remarks, rent: @prop.rent } }
